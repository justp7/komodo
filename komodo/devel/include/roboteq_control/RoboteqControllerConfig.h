...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RoboteqControllerConfig::AbstractParamDescriptionConstPtr(new RoboteqControllerConfig::ParamDescription<int>("mixing", "int", 0, "Type of mixing mode", "{'enum_description': 'operation mode', 'enum': [{'srcline': 16, 'description': 'direct control channels', 'srcfile': '/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'separate'}, {'srcline': 17, 'description': 'Mixed mode like tank - mode 1 (see reference)', 'srcfile': '/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'mode_1'}, {'srcline': 18, 'description': 'Mixed mode like tank - mode 2 (see reference)', 'srcfile': '/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'mode_2'}, {'srcline': 19, 'description': 'Mixed mode like tank - mode 3 (see reference)', 'srcfile': '/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'mode_3'}]}", &RoboteqControllerConfig::mixing)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(RoboteqControllerConfig::AbstractParamDescriptionConstPtr(new RoboteqControllerConfig::ParamDescription<int>("mixing", "int", 0, "Type of mixing mode", "{'enum_description': 'operation mode', 'enum': [{'srcline': 16, 'description': 'direct control channels', 'srcfile': '/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'separate'}, {'srcline': 17, 'description': 'Mixed mode like tank - mode 1 (see reference)', 'srcfile': '/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'mode_1'}, {'srcline': 18, 'description': 'Mixed mode like tank - mode 2 (see reference)', 'srcfile': '/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'mode_2'}, {'srcline': 19, 'description': 'Mixed mode like tank - mode 3 (see reference)', 'srcfile': '/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'mode_3'}]}", &RoboteqControllerConfig::mixing)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 16 "/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg"
      const int RoboteqController_separate = 0;
//#line 17 "/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg"
      const int RoboteqController_mode_1 = 1;
//#line 18 "/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg"
      const int RoboteqController_mode_2 = 2;
//#line 19 "/home/komodo/src/komodo2_utils/roboteq_control/cfg/RoboteqController.cfg"
