...
"""autogenerated by genpy from komodo2_perception/DetectedObjectsArray.msg. Do not edit."""
import codecs
import sys
...
import komodo2_perception.msg
import sensor_msgs.msg
import std_msgs.msg

class DetectedObjectsArray(genpy.Message):
  _md5sum = "84d084cecf89edbe15e16f7d85aab2e1"
  _type = "komodo2_perception/DetectedObjectsArray"
...
"""
  __slots__ = ['objects']
  _slot_types = ['komodo2_perception/DetectedObject[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = komodo2_perception.msg.DetectedObject()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        (_v4.is_dense,) = _get_struct_B().unpack(str[start:end])
