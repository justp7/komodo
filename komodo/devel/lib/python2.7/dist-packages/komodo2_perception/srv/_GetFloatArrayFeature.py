...
"""autogenerated by genpy from komodo2_perception/GetFloatArrayFeatureRequest.msg. Do not edit."""
import codecs
import sys
...
class GetFloatArrayFeatureRequest(genpy.Message):
  ...
  _type = "komodo2_perception/GetFloatArrayFeatureRequest"
...
def _get_struct_IBI():
    ...
    return _struct_IBI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from komodo2_perception/GetFloatArrayFeatureResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetFloatArrayFeatureResponse(genpy.Message):
  ...
  _type = "komodo2_perception/GetFloatArrayFeatureResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.feature))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.feature = s.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class GetFloatArrayFeature(object):
  _type          = 'komodo2_perception/GetFloatArrayFeature'
