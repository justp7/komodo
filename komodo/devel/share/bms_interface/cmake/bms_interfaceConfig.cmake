...
if("TRUE" STREQUAL "TRUE")
  set(bms_interface_SOURCE_PREFIX /home/komodo/src/komodo2_utils/bms_interface)
  set(bms_interface_DEVEL_PREFIX /home/komodo/devel)
  ...
  set(bms_interface_INSTALL_PREFIX /home/komodo/install)
...
if(NOT "/home/komodo/src/komodo2_utils/bms_interface/include " STREQUAL " ")
  set(bms_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/komodo/src/komodo2_utils/bms_interface/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bms_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/komodo/src/komodo2_utils/bms_interface/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT bms_interface_NUM_DUMMY_TARGETS)
      set(bms_interface_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::bms_interface::wrapped-linker-option${bms_interface_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR bms_interface_NUM_DUMMY_TARGETS "${bms_interface_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::bms_interface::wrapped-linker-option${bms_interface_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND bms_interface_LIBRARIES "${interface_target_name}")
