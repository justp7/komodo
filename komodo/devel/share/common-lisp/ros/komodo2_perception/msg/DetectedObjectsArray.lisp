...
(cl:defclass <DetectedObjectsArray> (roslisp-msg-protocol:ros-message)
  ((objects
    :reader objects
    :initarg :objects
    :type (cl:vector komodo2_perception-msg:DetectedObject)
   :initform (cl:make-array 0 :element-type 'komodo2_perception-msg:DetectedObject :initial-element (cl:make-instance 'komodo2_perception-msg:DetectedObject))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DetectedObjectsArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectedObjectsArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name komodo2_perception-msg:<DetectedObjectsArray> is deprecated: use komodo2_perception-msg:DetectedObjectsArray instead.")))

(cl:ensure-generic-function 'objects-val :lambda-list '(m))
(cl:defmethod objects-val ((m <DetectedObjectsArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader komodo2_perception-msg:objects-val is deprecated.  Use komodo2_perception-msg:objects instead.")
  (objects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DetectedObjectsArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'komodo2_perception-msg:DetectedObject))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectedObjectsArray>)))
  ...
  "komodo2_perception/DetectedObjectsArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectedObjectsArray)))
  "Returns string type for a message object of type 'DetectedObjectsArray"
  "komodo2_perception/DetectedObjectsArray")
