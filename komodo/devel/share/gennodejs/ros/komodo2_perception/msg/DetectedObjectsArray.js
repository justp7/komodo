...
// (in-package komodo2_perception.msg)
...
class DetectedObjectsArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DetectedObjectsArray(null);
  ...
  static datatype() {
    ...
    return 'komodo2_perception/DetectedObjectsArray';
  }
  ...
  static messageDefinition() {
    ...
    ================================================================================
    MSG: komodo2_perception/DetectedObject
  ...
  static Resolve(msg) {
    ...
    const resolved = new DetectedObjectsArray(null);
...
module.exports = DetectedObjectsArray;
